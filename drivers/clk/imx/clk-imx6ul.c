...
static const char *cko1_sels[] = {
	...
	"dummy", "axi", "enfc_podf", "dummy",
	"epdc",  "dummy", "lcdif_pix", "ahb",
	"ipg", "perclk", "ckil", "pll4_audio_div"
};
static const char *cko2_sels[] = {
	"dummy", "mmdc_p0_fast", "gpmi_bch", "usdhc1",
	"dummy", "wrck", "ecspi_podf", "dummy",
	"bch_podf", "dummy", "arm", "csi",
	"dummy", "dummy", "osc", "dummy",
	"dummy", "usdhc2", "sai1", "sai2",
	"sai3", "dummy", "dummy", "can_podf",
	"dummy", "qspi1", "dummy", "eim",
	"uart_podf", "spdif"
};
...
static void __init imx6ul_clocks_init(struct device_node *ccm_node)
{
	...
	clk_set_parent(clks[IMX6UL_CLK_CKO2_SEL], clks[IMX6UL_CLK_OSC]);
	clk_prepare_enable(clks[IMX6UL_CLK_CKO2]);
