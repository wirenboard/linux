...
static const struct iio_chan_spec wbec_iio_channels[] = {
	WBEC_IIO_CHANNEL(V_A1, IIO_VOLTAGE, BIT(IIO_CHAN_INFO_PROCESSED), "A1"),
	WBEC_IIO_CHANNEL(V_A2, IIO_VOLTAGE, BIT(IIO_CHAN_INFO_PROCESSED), "A2"),
	WBEC_IIO_CHANNEL(V_A3, IIO_VOLTAGE, BIT(IIO_CHAN_INFO_PROCESSED), "A3"),
	WBEC_IIO_CHANNEL(V_A4, IIO_VOLTAGE, BIT(IIO_CHAN_INFO_PROCESSED), "A4"),
