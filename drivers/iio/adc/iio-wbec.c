...
static const struct iio_chan_spec wbec_iio_channels[] = {
	WBEC_IIO_CHANNEL(V_A1, IIO_VOLTAGE, BIT(IIO_CHAN_INFO_RAW) | BIT(IIO_CHAN_INFO_PROCESSED) | BIT(IIO_CHAN_INFO_SCALE), "A1"),
	WBEC_IIO_CHANNEL(V_A2, IIO_VOLTAGE, BIT(IIO_CHAN_INFO_RAW) | BIT(IIO_CHAN_INFO_PROCESSED) | BIT(IIO_CHAN_INFO_SCALE), "A2"),
	WBEC_IIO_CHANNEL(V_A3, IIO_VOLTAGE, BIT(IIO_CHAN_INFO_RAW) | BIT(IIO_CHAN_INFO_PROCESSED) | BIT(IIO_CHAN_INFO_SCALE), "A3"),
	WBEC_IIO_CHANNEL(V_A4, IIO_VOLTAGE, BIT(IIO_CHAN_INFO_RAW) | BIT(IIO_CHAN_INFO_PROCESSED) | BIT(IIO_CHAN_INFO_SCALE), "A4"),
	WBEC_IIO_CHANNEL(V_IN, IIO_VOLTAGE, BIT(IIO_CHAN_INFO_RAW) | BIT(IIO_CHAN_INFO_PROCESSED) | BIT(IIO_CHAN_INFO_SCALE), "IN"),
	WBEC_IIO_CHANNEL(V_3_3, IIO_VOLTAGE, BIT(IIO_CHAN_INFO_RAW) | BIT(IIO_CHAN_INFO_PROCESSED) | BIT(IIO_CHAN_INFO_SCALE), "3V3"),
	WBEC_IIO_CHANNEL(V_5_0, IIO_VOLTAGE, BIT(IIO_CHAN_INFO_RAW) | BIT(IIO_CHAN_INFO_PROCESSED) | BIT(IIO_CHAN_INFO_SCALE), "5V"),
	WBEC_IIO_CHANNEL(VBUS_CONSOLE, IIO_VOLTAGE, BIT(IIO_CHAN_INFO_RAW) | BIT(IIO_CHAN_INFO_PROCESSED) | BIT(IIO_CHAN_INFO_SCALE), "VBUS_CONSOLE"),
	WBEC_IIO_CHANNEL(VBUS_NETWORK, IIO_VOLTAGE, BIT(IIO_CHAN_INFO_RAW) | BIT(IIO_CHAN_INFO_PROCESSED) | BIT(IIO_CHAN_INFO_SCALE), "VBUS_DEBUG"),
